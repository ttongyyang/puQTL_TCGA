...
SNP_file_name <- paste0("./TCGA/snp_matrix/",fin1,".snpmatrix")
expression_file_name <- paste0("./TCGA/promoter_usage/",fin1)
covariates_file_name <- paste0("./TCGA/combine/",fin1,".covariates")
...
genepos = read.table(paste0("./TCGA/location/promoter/",fin1,".txt"),header=TRUE,stringsAsFactors=FALSE)
snpspos = read.table(paste0("./TCGA/location/snp/",fin1,".snp.loc"),header=TRUE,stringsAsFactors=FALSE)
output_file_name_cis = paste("./TCGA/peer/",fin1,".txt",sep="");
output_file_name     = paste("./TCGA/peer/",fin1,".txt",sep="")
...
verbose = TRUE
output_file_name.cis = paste("./TCGA/peer/",fin1,".txt",sep="")
